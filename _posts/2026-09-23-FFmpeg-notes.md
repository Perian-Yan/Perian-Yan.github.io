---
layout: post
title:  Some FFmpeg Commands for ICRA Video
date:   2026-09-23
description: for icra 2027 accompanying video
tags: tools
categories: 
---
...
Davinci Resolve exports clips as `.mov`, using the following command to change it to `.mp4`. Only change the container while keeping the codec.
```sh
